# 🌀 Smart Fan Manager — HACS Integration
...
2. Nhập URL: `https://github.com/yourusername/smart_fan_manager`
3. Category: **Integration** → **Add**

### Bước 2: Cài đặt integration

1. Tìm **Smart Fan Manager** trong HACS → **Download**
2. Khởi động lại Home Assistant

### Bước 3: Thêm quạt đầu tiên

1. **Settings** → **Devices & Services** → **Add Integration**
2. Tìm **Smart Fan Manager**
3. Điền thông tin:
...
2. Thay thế các placeholder:
   - `ENTRY_ID` → entry_id thực tế *(Settings > Devices > Smart Fan Manager > tên quạt > Entry ID)*
  ...
  - alias: Bật quạt trước giờ làm
    ...
    condition:
      - condition: numeric_state
        ...
        above: 35
    action:
      - service: smart_fan_manager.set_timer
        data:
  ...
  - alias: Giải nhiệt sau workout
    trigger:
      - platform: state
        ...
        to: "off"
    action:
      - service: smart_fan_manager.set_mode
        data:
...
### `smart_fan_manager.cancel_timer`
```yaml
...
- Issues: https://github.com/yourusername/smart_fan_manager/issues
- Discussions: https://github.com/yourusername/smart_fan_manager/discussions
